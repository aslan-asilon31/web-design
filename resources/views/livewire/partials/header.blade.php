  ...
  <div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
    <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
      ...
      {{-- <a class="block flex-shrink-0 lg:hidden" href="index.html">
        <img src="/themes/default/images/logo/logo-icon.svg" alt="Logo" />
      </a> --}}
    </div>
            ...
            <ul class="flex h-auto flex-col overflow-y-auto">
              <li>
                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                  ...
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="/themes/default/images/user/user-02.png" alt="User" />
                  </div>
              ...
              <li>
                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                  href="messages.html">
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="/themes/default/images/user/user-01.png" alt="User" />
                  </div>
              ...
              <li>
                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                  href="messages.html">
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="/themes/default/images/user/user-03.png" alt="User" />
                  </div>
              ...
              <li>
                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                  href="messages.html">
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="/themes/default/images/user/user-04.png" alt="User" />
                  </div>
      ...
      <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
        <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
          <span class="hidden text-right lg:block">
            <span
              class="block text-sm font-medium text-black dark:text-white">{{ $user?->employee?->name ?? 'No Name' }}</span>
            <span class="block text-xs font-medium">{{ $user?->employee?->position?->name ?? 'No Position' }}</span>
          </span>

          <span class="h-12 w-12">
            {{-- <img src="/themes/default/images/user/user-01.png" alt="User" class="rounded-full" /> --}}
            <img src="/themes/default/images/user/user.jpg" alt="User" class="rounded-full" />
          </span>
        ...
        <div x-show="dropdownOpen"
          ...
          <button wire:click.debounce.500ms="logout"
            class="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base text-red-500">
            <svg class="fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
