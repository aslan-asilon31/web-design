              ...
              <div
                ...
                <div class="mt-4 px-5 pb-5">
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    @if ($product->in_cart)
                      <a wire:click="filterRemoveFromCart('{{ $product->id }}')"
                        class="flex items-center rounded-md bg-red-900 px-2 py-2 text-center text-xs font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
                    ...
                    @else
                      <a wire:click="filterAddToCart('{{ $product->id }}')"
