...
return new class extends Migration
{
  ...
  {
    Schema::create('product_content_marketplaces', function (Blueprint $table) {
      $table->uuid('id')->primary();
      $table->uuid('marketplace_id');
      $table->foreign('marketplace_id')->references('id')->on('marketplaces')->onDelete('cascade')->onUpdate('cascade');
  ...
  {
    Schema::dropIfExists('product_content_marketplaces');
  }
};
